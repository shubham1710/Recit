"""
Django settings for recit project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY_RECIT')
...
WSGI_APPLICATION = 'recit.wsgi.application'
...
GCS_BUCKET = os.environ.get('GCS_BUCKET_RECIT')
